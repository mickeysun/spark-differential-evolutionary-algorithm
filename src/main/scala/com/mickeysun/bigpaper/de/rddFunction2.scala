...
import com.mickeysun.bigpaper.population.{FitnessFuntion, Individual, Setup}
import org.apache.spark.broadcast.Broadcast

/**
  * Created by mickeysun on 18-5-30.
  */
class rddFunction2 (broadcastSetup:Broadcast[Setup]) extends Serializable{
